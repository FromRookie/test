...
_Generated: 2026-07-16T04:27:48.997Z_
...
- **c:\xushi\Software\Python\test\TEST\test\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\xushi\.claude.json** — _File exists — no servers defined_
